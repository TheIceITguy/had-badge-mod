from net._sx126x import *
from net.sx126x import SX126X
...
class SX1262(SX126X):
    ...
    def __init__(self, spi_host, sck, mosi, miso, cs, irq, rst, gpio):
        super().__init__(spi_host, sck, mosi, miso, cs, irq, rst, gpio)
